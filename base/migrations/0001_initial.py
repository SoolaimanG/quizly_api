    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booleanOption', models.BooleanField(default=False)),
                ...
                ('question_image', models.ImageField(blank=True, null=True, upload_to=base.helpers.upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=base.helpers.upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('expires', models.DateTimeField(default=datetime.datetime(2024, 1, 9, 1, 24, 34, 763187, tzinfo=datetime.timezone.utc))),
                ('verify_token', models.UUIDField(default=uuid.uuid4, unique=True)),
                ('number_of_requests', models.IntegerField(default=1)),
                ('next_request', models.DateTimeField(default=datetime.datetime(2024, 1, 9, 1, 9, 34, 763187, tzinfo=datetime.timezone.utc))),
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='ForgetPassword',
            fields=[
                ('expires_by', models.DateTimeField(default=datetime.datetime(2024, 1, 9, 1, 24, 34, 762189, tzinfo=datetime.timezone.utc))),
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False, unique=True)),
                ('number_of_request', models.IntegerField(default=1)),
                ('otp', models.CharField(max_length=5)),
                ('next_request', models.DateTimeField(default=datetime.datetime(2024, 1, 9, 1, 0, 4, 762189, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.TextField(choices=[('quiz_alert', 'QUIZ_ALERT'), ('like', 'LIKE'), ('comment', 'COMMENT'), ('message', 'MESSAGE'), ('student', 'STUDENT'), ('community_request', 'COMMUNITY_REQUEST')], default='message')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.ImageField(blank=True, null=True, upload_to=base.helpers.upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to=base.helpers.upload_to)),
                ...
                ('instructions', models.TextField(blank=True, max_length=3000, null=True)),
